namespace VistaGL
{
    ...
    {
        private static string[] databaseKeys = new[] { "Default", "ACCDB" };
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want VistaGL migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "VistaGL.Migrations." + databaseKey //+ "DB"
                };
