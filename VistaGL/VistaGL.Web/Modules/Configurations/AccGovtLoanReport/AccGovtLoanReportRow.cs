...
namespace VistaGL.Configurations.Entities
{
    ...
    [ConnectionKey("ACCDB"), Module("Configurations"), TableName("[dbo].[acc_GovtLoanReport]")]
    [DisplayName("Govt Loan"), InstanceName("Govt Loan")]
    [ReadPermission("Configurations:AccGovtLoanReport:Read")]
    [InsertPermission("Configurations:AccGovtLoanReport:Insert")]
    [UpdatePermission("Configurations:AccGovtLoanReport:Update")]
    [DeletePermission("Configurations:AccGovtLoanReport:Delete")]
    [LookupScript("Configurations.AccGovtLoanReport", Permission = "?")]
    public sealed class AccGovtLoanReportRow : Row, IIdRow
    {
        ...
        [DisplayName("Loan Opening"), Size(18), Scale(2)]
        public Decimal? LoanOpening
        {
            get { return Fields.LoanOpening[this]; }
            set { Fields.LoanOpening[this] = value; }
        }

        [DisplayName("Loan Refund Opening"), Size(18), Scale(2)]
        public Decimal? LoanRefundOpening
        {
            get { return Fields.LoanRefundOpening[this]; }
            set { Fields.LoanRefundOpening[this] = value; }
        }

        [DisplayName("Is Interest Free?"), NotNull]
        public Boolean? IsInterestFree
        {
            get { return Fields.IsInterestFree[this]; }
            set { Fields.IsInterestFree[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public DecimalField LoanOpening;

            public DecimalField LoanRefundOpening;

            public BooleanField IsInterestFree;
