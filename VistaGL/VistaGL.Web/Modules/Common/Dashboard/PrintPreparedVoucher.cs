...
namespace VistaGL.Modules.Common.Dashboard
{
    ...
    [Report("Dashboard.PrintPreparedVoucher")]
    [ReportDesign(MVC.Views.Common.Dashboard.PrintPreparedVoucher)]
    //[RequiredPermission(??)]
    public class PrintPreparedVoucher : IReport, ICustomizeHtmlToPdf
    {
        ...
        public object GetData()
        {
            ...
            using (var connection = SqlConnections.NewFor<DashboardPrintModel>())
            {
                ...
                param8.Add("@IsPostedOnly", 0);
                param8.Add("@ApproveType", Convert.ToInt32(ApprovalStatus.Draft));
