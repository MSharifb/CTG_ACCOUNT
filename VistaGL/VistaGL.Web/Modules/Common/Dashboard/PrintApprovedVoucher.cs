...
{
    [Report("Dashboard.PrintApprovedVoucher")]
    [ReportDesign(MVC.Views.Common.Dashboard.PrintApprovedVoucher)]
    public class PrintApprovedVoucher : IReport, ICustomizeHtmlToPdf
    {
