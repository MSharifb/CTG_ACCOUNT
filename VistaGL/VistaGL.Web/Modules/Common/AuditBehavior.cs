...
namespace VistaGL.Modules.Common
{
    ...
    public class AuditRowBehavior : IImplicitBehavior, ISaveBehavior, IDeleteBehavior
    {
        ...
        public void OnAudit(ISaveRequestHandler handler)
        {
            ...
            {
                connection.Open();
                ExecuteAuditLogProc(connection, AuditAction, handler.Row, auditLog);
                connection.Close();
            }
        }
        ...
        public void OnAudit(IDeleteRequestHandler handler)
        {
            ...
            {
                connection.Open();
                ExecuteAuditLogProc(connection, AuditActionType.Delete, handler.Row, auditLog);
                connection.Close();
            }
        }
