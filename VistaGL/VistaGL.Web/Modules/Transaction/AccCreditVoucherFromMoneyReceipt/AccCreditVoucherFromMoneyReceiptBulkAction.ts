...
namespace VistaGL.Transaction {
    ...
    export class AccCreditVoucherFromMoneyReceiptBulkAction extends Common.BulkServiceAction {
        ...
        protected executeForBatch(batch) {
            AccCreditVoucherFromMoneyReceiptService.BulkAction(
                {
                    IDs: batch.map(x => Q.parseInteger(x))
                },
