...
namespace VistaGL.Transaction.Entities
{
    ...
    [ConnectionKey("ACCDB"), TableName(TableName)]
    [DisplayName("Party Payment"), InstanceName("Party Payment"), TwoLevelCached]
    [ReadPermission("Transaction:AccPartyPayment:Read")]
    [InsertPermission("Transaction:AccPartyPayment:Insert")]
    [UpdatePermission("Transaction:AccPartyPayment:Update")]
    [DeletePermission("Transaction:AccPartyPayment:Delete")]
    [LookupScript("Transaction.AccPartyPayment")]
    public sealed class AccPartyPaymentRow : NRow, IIdRow, INameRow, IAuditLog
    {
            #region Id
            ...
            #region Party
            [DisplayName("Party"), ForeignKey("[dbo].[acc_Cost_Centre_or_Institute_Information]", "id"), LeftJoin("jParty"), TextualField("PartyCode")]
            [LookupEditor("Transaction.AccCostCentreOrInstituteInformation_Lookup")]
            public Int32? PartyId { get { return Fields.PartyId[this]; } set { Fields.PartyId[this] = value; } }
            public partial class RowFields { public Int32Field PartyId; }
            #endregion PartyId
            ...
            #region Narration
            [DisplayName("Narration"), Size(500), NotNull]
    ...
    #region Foreign Fields
                ...
                [DisplayName("Party Code"), Expression("jParty.[code]")]
                public String PartyCode { get { return Fields.PartyCode[this]; } set { Fields.PartyCode[this] = value; } }
                public partial class RowFields { public StringField PartyCode; }


                [DisplayName("Party Code Count"), Expression("jParty.[codeCount]")]
                public Int32? PartyCodeCount { get { return Fields.PartyCodeCount[this]; } set { Fields.PartyCodeCount[this] = value; } }
                public partial class RowFields { public Int32Field PartyCodeCount; }


                [DisplayName("Party User Code"), Expression("jParty.[userCode]")]
                public String PartyUserCode { get { return Fields.PartyUserCode[this]; } set { Fields.PartyUserCode[this] = value; } }
                public partial class RowFields { public StringField PartyUserCode; }


                [DisplayName("Party Is Institute"), Expression("jParty.[isInstitute]")]
                public Boolean? PartyIsInstitute { get { return Fields.PartyIsInstitute[this]; } set { Fields.PartyIsInstitute[this] = value; } }
                public partial class RowFields { public BooleanField PartyIsInstitute; }
                ...
                [DisplayName("Party Pa Ammount"), Expression("jParty.[paAmmount]")]
                public Decimal? PartyPaAmmount { get { return Fields.PartyPaAmmount[this]; } set { Fields.PartyPaAmmount[this] = value; } }
                public partial class RowFields { public DecimalField PartyPaAmmount; }


                [DisplayName("Party Remarks"), Expression("jParty.[remarks]")]
                public String PartyRemarks { get { return Fields.PartyRemarks[this]; } set { Fields.PartyRemarks[this] = value; } }
                public partial class RowFields { public StringField PartyRemarks; }


                [DisplayName("Party Parent Id"), Expression("jParty.[parentId]")]
                public Int32? PartyParentId { get { return Fields.PartyParentId[this]; } set { Fields.PartyParentId[this] = value; } }
                public partial class RowFields { public Int32Field PartyParentId; }


                [DisplayName("Party Entity Id"), Expression("jParty.[entityId]")]
                public Int32? PartyEntityId { get { return Fields.PartyEntityId[this]; } set { Fields.PartyEntityId[this] = value; } }
                public partial class RowFields { public Int32Field PartyEntityId; }


                [DisplayName("Party Sub Ledger Type Id"), Expression("jParty.[CostCenterTypeId]")]
                public Int32? PartyCostCenterTypeId { get { return Fields.PartyCostCenterTypeId[this]; } set { Fields.PartyCostCenterTypeId[this] = value; } }
                public partial class RowFields { public Int32Field PartyCostCenterTypeId; }


                [DisplayName("Co A Account Code"), Expression("jCoA.[accountCode]")]
                ...
                [DisplayName("Co A Account Code Count"), Expression("jCoA.[accountCodeCount]")]
                ...
                [DisplayName("Co A Account Group"), Expression("jCoA.[accountGroup]")]
                ...
                [DisplayName("Co A Account Name"), Expression("jCoA.[accountName]")]
                ...
                [DisplayName("Co A Account Name Bangla"), Expression("jCoA.[accountNameBangla]")]
                ...
                [DisplayName("Co A Is Bill Ref"), Expression("jCoA.[isBillRef]")]
                ...
                [DisplayName("Co A Level"), Expression("jCoA.[level]")]
                ...
                [DisplayName("Co A Mailing Address"), Expression("jCoA.[mailingAddress]")]
                ...
                [DisplayName("Co A Mailing Name"), Expression("jCoA.[mailingName]")]
                ...
                [DisplayName("Co A Remarks"), Expression("jCoA.[remarks]")]
                ...
                [DisplayName("Co A Tax Id"), Expression("jCoA.[taxID]")]
                ...
                [DisplayName("Co A Ugc Code"), Expression("jCoA.[ugcCode]")]
                ...
                [DisplayName("Co A Multi Currency Id"), Expression("jCoA.[MultiCurrencyID]")]
                ...
                [DisplayName("Co A Effect Cash Flow"), Expression("jCoA.[EffectCashFlow]")]
                ...
                [DisplayName("Co A User Code"), Expression("jCoA.[UserCode]")]
    ...
    public const string TableName = "[dbo].[acc_PartyPayment]";

    public partial class RowFields : NRowFields
    {
    public RowFields()
    : base("[dbo].[acc_PartyPayment]")
    {
    LocalTextPrefix = "Transaction.AccPartyPayment";
    }
    }
    #endregion RowFields
    }
