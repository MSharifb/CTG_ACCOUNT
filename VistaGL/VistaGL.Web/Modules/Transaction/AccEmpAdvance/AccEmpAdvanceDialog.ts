...
namespace VistaGL.Transaction {
    ...
    export class AccEmpAdvanceDialog extends EntityDialogBase<AccEmpAdvanceRow, any> {
        ...
        protected getToolbarButtons() {
            ...
            buttons.push({
                ...
                onClick: (x) => {
                    ...
                    b.form.PaytoOrReciveFrom.value = this.form.EmpId.get_text();
                    ...
                    b.form.ConversionAmount.value = b.form.ConversionRate.value * this.form.Amount.value;
                    b.addtoGrid();
                    b.form.EmpId.value = +this.form.EmpId.value;
