...
namespace VistaGL.Transaction {
    ...
    export class AccVoucherConfigurationDialog extends EntityDialogBase<AccVoucherConfigurationRow, any> {
        protected getFormKey() { return AccVoucherConfigurationForm.formKey; }
        ...
        protected getNameProperty() { return AccVoucherConfigurationRow.nameProperty; }
        protected getService() { return AccVoucherConfigurationService.baseUrl; }

        protected form = new AccVoucherConfigurationForm(this.idPrefix);     
