...
namespace VistaGL
{
    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your VistaGL Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your VistaGL Account";
                    ...
                    public static LocalText FormTitle = "Sign up for VistaGL";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "VistaGL";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText FooterCopyright = @"Designed &amp; Developed by <a href=""http://technovista.com.bd?ref=bepza"" target=""_blank"">TechnoVista Limited</a>";
    ...
    public static class Schemas
    {
        ...
        public const string yard = "yms";
        public const string bill = "bgm";
    }
}