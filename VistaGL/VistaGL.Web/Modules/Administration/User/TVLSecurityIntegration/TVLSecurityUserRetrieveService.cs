namespace VistaGL.Administration
{
    ...
    public class TVLSecurityUserRetrieveService : IUserRetrieveService
    {
        ...
        public void LoadUserMenuAndPermistions(string username, string currentModule = "ACC")
        {
            ...
            //if (ConfigurationManager.AppSettings["RetriveNavigationItemsFromExternalService"] == "true")
            //{
            //}
            //else
            //{
            //    menues.AddRange(u.GetMenus(userDefinition.Username, "MPA", "yard").ToList());
            //    menues.AddRange(u.GetMenus(userDefinition.Username, "MPA", "bgm").ToList());
            //}
                menues = u.GetMenus(userDefinition.Username, "ACC", "ACC").ToList();
