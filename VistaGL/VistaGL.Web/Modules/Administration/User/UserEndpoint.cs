...
namespace VistaGL.Administration.Endpoints
{
    using Entities;
    using Repositories;
    using Serenity;
    ...
    public class UserController : Controller
    {
        ...
        public ScriptUserDefinition GetUserData()
        {
            ...
            result.FundControlInformationId = user.FundControlInformationId;
            result.ZoneID = user.ZoneID;
            result.BaseCurrency = user.BaseCurrency;
            result.BaseCurrencyId = user.BaseCurrencyId;
            result.ZoneName = user.ZoneName;
            result.FundControlName = user.FundControlName;
            result.FinancialYearName = user.FinancialYearName;
            result.EmpId=user.EmpId;
            result.DesignationName=user.DesignationName;
