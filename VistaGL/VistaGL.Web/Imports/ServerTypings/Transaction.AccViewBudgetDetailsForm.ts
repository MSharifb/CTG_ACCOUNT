namespace VistaGL.Transaction {
    export interface AccViewBudgetDetailsForm {
    ...
    export class AccViewBudgetDetailsForm extends Serenity.PrefixedContext {
        static formKey = 'Transaction.AccViewBudgetDetails';
