...
{
    public partial class myReceiptPaymentBudgetRV : System.Web.UI.Page
    {
        #region Fields
        ...
        #region Ctor
        public myReceiptPaymentBudgetRV()
        {
        ...
        private void GetDate()
        {
            if (Session["dt"] != null)
            {
                ...
                var dt = Session["dt"];
                var dtOpen = Session["dtopening"];
                var dtClose = Session["dtclosing"];
                ...
                ReportDataSource rdcOpen = new ReportDataSource("DSOpen", dtOpen);
                ReportDataSource rdcClose = new ReportDataSource("DSClose", dtClose);

                ReportViewer1.LocalReport.DataSources.Add(rdc);
                ReportViewer1.LocalReport.DataSources.Add(rdc1);
                ReportViewer1.LocalReport.DataSources.Add(rdcOpen);
                ReportViewer1.LocalReport.DataSources.Add(rdcClose);
