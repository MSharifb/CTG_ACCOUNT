...
{
    public partial class myAuditReportViewer : System.Web.UI.Page
    {
        #region Fields
        ...
        private void GetDate()
        {
            if (Session["dt"] != null)
            {
                ...
                ReportParameter p7 = new ReportParameter("pIsShowYear", model.FundcontrolId.ToString());
                ReportParameter p8 = new ReportParameter("pLevel", baseUrl);
