...
{
    public partial class myBankBookViewer : System.Web.UI.Page
    {
        #region Fields
        ...
        private void GetDate()
        {
            if (Session["dt"] != null)
            {
                ...
                #region report Title & Parameters
                ...
                ReportParameter p16 = new ReportParameter("pIsWithNarration", model.IsWithNarration ? "yes" : "no");
                ReportViewer1.LocalReport.SetParameters(new ReportParameter[] { p10, p11, p12, p13, p14, p15, p16 });
